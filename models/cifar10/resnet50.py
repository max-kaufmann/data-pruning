...
class BasicBlock_robust(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        super(BasicBlock_robust, self).__init__()
...
class Bottleneck_robust(nn.Module):
    expansion = 4

    def __init__(self, in_planes, planes, stride=1):
        super(Bottleneck_robust, self).__init__()
...
class BasicBlock_standard(nn.Module):
    expansion = 1
    ...
    def __init__(
        ...
        super(BasicBlock_standard, self).__init__()
...
class Bottleneck_standard(nn.Module):
    expansion = 4
    ...
    def __init__(
        ...
        super(Bottleneck_standard, self).__init__()
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
...
# Standard models taken from https://github.com/huyvnphan/PyTorch_CIFAR10/
class ResNet_standard(nn.Module):
    def __init__(
        self,
        block,
        layers,
        ...
        super(ResNet_standard, self).__init__()
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
        ...
        if zero_init_residual:
            for m in self.modules():
                if isinstance(m, Bottleneck_standard):
                    nn.init.constant_(m.bn3.weight, 0)
                elif isinstance(m, BasicBlock_standard):
...
def ResNet50_robust(**kwargs):
    return ResNet_robust(Bottleneck_robust, [3,4,6,3], **kwargs)

def ResNet50_standard(**kwargs):
