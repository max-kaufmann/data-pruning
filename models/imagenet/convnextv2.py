...
# This source code is licensed under the license found in https://github.com/facebookresearch/ConvNeXt-V2/blob/main/LICENSE, and is only for non-commerical usage
